...
%DIF DEL supplemental-orig.tex   Tue May 24 23:11:37 2016
%DIF ADD supplemental-rev.tex    Wed May 25 01:01:57 2016
...
\usepackage{xr}
%DIF 23c23
%DIF < \externaldocument{skewt-orig}
%DIF -------
\externaldocument{skewt-rev} %DIF > 
%DIF -------
...
\DIFaddend which goes to \DIFdelbegin \DIFdel{one as $h \rightarrow \infty$.
}\DIFdelend \DIFaddbegin \DIFadd{1 as $h$ goes to infinity.
}
