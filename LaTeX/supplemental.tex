...
Without loss of generality, shift $A$ so that its center is at the point $(0, 0)$, and rotate $A$ so that $\bs_1$ and $bs_2$ are on the $x$ axis.
Partition $A$ into four equal sized partitions, $A_1, A_2, A_3, A_4$ corresponding to the four quadrants of the Cartesian plane.
The probability of 
