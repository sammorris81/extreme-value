...
In each Metropolis Hastings update, we tune the algorithm to give acceptance rates near 0.40.d
...
First, we generate candidate knots locations using a random walk Gaussian candidate distribution
\begin{align*}
