...
xplot <- probs[1:12]
plot(xplot, brier.score.mean[4, 1:12], type="b", ylim=c(0.8, 1.2), pch=21,
...
plot(xplot, brier.score.mean[4, these.probs], type="b", ylim=c(0.755, 0.95), pch=21,
...
lines(xplot, brier.score.mean[5, these.probs], type="b", pch=21, col=col[2], bg=bg[2],
      cex=1.3, lty=1)
lines(xplot, brier.score.mean[8, these.probs], type="b", pch=22, col=col[1], bg=bg[1],
      cex=1.3, lty=1)
lines(xplot, brier.score.mean[9, these.probs], type="b", pch=22, col=col[2], bg=bg[2],
      cex=1.3, lty=1)
lines(xplot, brier.score.mean[12, these.probs], type="b", pch=24, col=col[1], bg=bg[1],
      cex=1.3, lty=1)
lines(xplot, brier.score.mean[13, these.probs], type="b", pch=24, col=col[2], bg=bg[2],
      cex=1.3, lty=1)
abline(h=1, lty=2)
