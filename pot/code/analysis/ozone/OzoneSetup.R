...
# setting 2:  T = 0.80,  1 partition
# setting 3:  T = 0.95,  1 partition
# setting 4:  T = 0.99,  1 partition
# setting 5:  T = 0.00,  5 partitions
# setting 6:  T = 0.80,  5 partitions
# setting 7:  T = 0.95,  5 partitions
# setting 8:  T = 0.99,  5 partitions
# setting 9:  T = 0.00, 10 partitions
# setting 10: T = 0.80, 10 partitions
# setting 11: T = 0.95, 10 partitions
# setting 12: T = 0.99, 10 partitions